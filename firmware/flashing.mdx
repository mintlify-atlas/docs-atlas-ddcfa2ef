---
title: "Flash Firmware to the ESP32 Controller Board"
sidebarTitle: "Flashing"
description: "Connect the Controller PCB via Micro-USB, select the correct COM port in Arduino IDE, and upload the firmware to the ESP32."
---
