...
description: "An open-source, desktop-scale dual-wheeled-leg balancing robot using ESP32, SimpleFOC motor control, LQR self-balancing, and WiFi remote control via a browser."
---
