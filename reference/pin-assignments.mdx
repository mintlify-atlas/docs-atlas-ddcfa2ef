...
description: "Complete GPIO pinout for the Micro Wheeled-Leg Robot Controller PCB: motor PWM, encoder I2C buses, servo UART, battery ADC, and LED pin assignments."
---
...
| 17 | TX | Serial2 (UART2) | 1,000,000 | STS3032 servo bus TX → Servo Debug PCB |
| 16 | RX | Serial2 (UART2) | 1,000,000 | STS3032 servo bus RX ← Servo Debug PCB |
