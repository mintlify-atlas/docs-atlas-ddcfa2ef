---
title: "WebSocket JSON Control Protocol Reference"
sidebarTitle: "WebSocket Protocol"
description: "Reference for the WebSocket JSON protocol used by the browser interface to control the Micro Wheeled-Leg Robot: message format, field types, and direction encoding."
---
